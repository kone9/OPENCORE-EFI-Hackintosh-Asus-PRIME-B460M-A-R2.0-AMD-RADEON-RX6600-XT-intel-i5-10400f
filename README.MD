...
## This EFI has a basic boot interface, it is configured to install the OS with usb, keyboard, mouse, network cable and starts with amd radeon the rx 6600 xt external graphics and uses intel i5 10400f processor
